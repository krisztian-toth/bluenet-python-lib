...
```
sudo apt-get install build-essential libbluetooth-dev libglib2.0-dev python3-setuptoolslibbluetooth-dev libglib2.0-dev
```
...
```
sudo python3 ./examples/exampleBle.py
```
